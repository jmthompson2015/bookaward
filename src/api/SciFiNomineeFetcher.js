...
require(["artifact/SciFiAward", "model/BookComparator", "model/NominationComparator", "utility/ArrayUtilities", "utility/Logger", "api/DCLURLFetcher", "api/SFADBNomineeFetcher"],
   function(Award, BookComparator, NominationComparator, ArrayUtilities, Logger, DCLURLFetcher, NomineeFetcher)
   {
      ...
      {
         Award.values().forEach(awardFunction);
      }
      ...
      function callback0(newBooks, newBookToNomination)
      {
         ...
         if (count0 === (year1 - year0 + 1) * Award.values().length)
         {
